...
public class RPG_Game {
    ...
    public static void startGame() {
        Thor thor = new Thor("Thor", 400, 50);
        Golem golem = new Golem("Golem", 800, 30);
        Witcher witcher = new Witcher("Witcher", 600, 20);
        TrickyBastard trickyBastard = new TrickyBastard("TrickyBastard", 250, 25);
        ...
        Hero[] heroes = {warrior, doc, magic, berserk, assistant, thor, golem, witcher, trickyBastard};
